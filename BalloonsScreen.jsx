...
export default function BalloonsScreen({ onNext }) {
  ...
  const balloons = [{ text: "Always", color: "fill-pink-500/50" }, { text: "be", color: "fill-rose-500/50" }, { text: "Happy", color: "fill-purple-500/50" }]
    ...
    >
      ...
      >
        <h1 className="text-3xl md:text-4xl text-pink-200 leading-tight font-semibold">
          This is what I want to say for <span className="text-pink-400 font-bold">you...</span>
        </h1>
        <motion.p
