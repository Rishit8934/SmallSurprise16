...
export default function FinalScreen() {
  ...
  const proposalMessage = `Always keep smiling, because your smile has the power to brighten any day.
Stay happy, because happiness makes you shine in a way nothing else can.

No matter what challenges come, never let them take away your joy.
Your strength, positivity, and kindness deserve to be wrapped in happiness every single day.

Be happy always, because you truly deserve nothing less.`
