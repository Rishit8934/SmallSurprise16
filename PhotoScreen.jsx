        ...
        >
            ...
            >
                <h1 className="text-2xl md:text-3xl text-pink-200 leading-relaxed mb-4 font-semibold">
                    From today and every day ahead, may your life keep getting <span className="text-pink-400 font-bold">brighter...</span>
                </h1>
                ...
                <motion.p
                    ...
                    transition={{ delay: 1 }}
                >
                    Stay happy, because your joy makes everything brighter 💕
                </motion.p>
            </motion.div>
